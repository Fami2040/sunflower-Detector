...
5. **Evidence-based training choices for dense benchtop seeds.** Augmentation policy cites **GrainNet** (heavy offline aug; validation MAE ~5.97 — not comparable to our test **61.3**) and **LWCD-YOLO** (corn kernels; **they report** mosaic disabled in §3.1). **ARCH-MOSAIC0-AB** tested S2 `mosaic=0` on our trays → test MAE **147.4** (rejected); retain low mosaic ([`training_tech_scan_2026_augmentation.md`](../research/training_tech_scan_2026_augmentation.md) §2.6; [`lit_audit/lwcd_yolo2025.md`](../../reports/manuscript/lit_audit/lwcd_yolo2025.md)).
...
|------|---------------------|----------------|-----------------|---------------------|---------------|
| **GrainNet** | `grainnet2025` · [DOI 10.1186/s13007-025-01363-y](https://doi.org/10.1186/s13007-025-01363-y) | Benchtop **wheat grains**; YOLOv7-based GrainNet (ASF-GD, EMA) | Counting **MAE ~5.97**, **R²** on **validation**; **RMSE** (not rRMSE) | Single-class-style counting; offline mosaic/mixup | **Two-class** sunflower; val-locked **test** MAE primary; do not equate 5.97 to 61.3 |
| **LWCD-YOLO** | `lwcd_yolo2025` · [DOI 10.3390/agriculture15181968](https://doi.org/10.3390/agriculture15181968) | Benchtop **corn seeds**; YOLOv11 lightweight | mAP + **Grad-CAM** on localization errors | **They report** mosaic disabled (§3.1) | Same dense-benchtop peer; **our S2 mosaic=0 failed** (147.4 MAE); Grad-CAM narrative (**MS-EXPLAIN**) |
