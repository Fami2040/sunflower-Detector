...
MANIFEST_CONFIRM="${GPU_QUEUE_MANIFEST_CONFIRM:-configs/experiments/archive/gpu_queue_aug_confirm.json}"
MANIFEST_FULL="${GPU_QUEUE_MANIFEST_FULL:-configs/experiments/archive/gpu_queue_full.json}"
MANIFEST_CLOSE_PHASE_A="${GPU_QUEUE_MANIFEST_CLOSE_PHASE_A:-configs/experiments/archive/gpu_queue_aug_close_phase_a.json}"
MANIFEST_CLOSE_100EP="${GPU_QUEUE_MANIFEST_CLOSE_100EP:-configs/experiments/archive/gpu_queue_aug_close_100ep.json}"
MANIFEST="${GPU_QUEUE_MANIFEST:-configs/experiments/gpu_queue_post_zoo_smoke.json}"
MODE="${1:-dry-run}"
